...
public class Carro {
    ...
    private Carro(Motorista motorista, String placa, Cor cor) {
        ...
        validadorCarro(placa, cor, motorista);
    ...
    public void validadorCarro(String placa, Cor cor, Motorista motorista){
        if (placa == null) {
            throw new NullPointerException("Veículo sem placa cadastrada.");
        }
        if (cor == null){
            throw new NullPointerException("Veículo sem cor cadastrada.");
        }
        if (motorista == null) {

            throw new EstacionamentoException("Veículo sem motorista válido cadastrado.");
        }
    }
}
