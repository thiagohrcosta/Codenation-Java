...
public class Motorista {
    ...
    private Motorista(String nome, int idade, int pontos, String habilitacao) {
        if (nome == null || nome.isEmpty()){
            throw new NullPointerException("Motorista sem nome válido cadastrado.");
        }
        if (habilitacao == null || habilitacao.isEmpty()){
            throw new NullPointerException("Motorista sem habilitação válida cadastrada.");
        }
        this.nome = nome;
        this.idade = idade;
        this.pontos = pontos;
    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withIdade(int idade) {
            if (idade < 0) throw new IllegalArgumentException("Idade cadastrada possui valores negativos.");
            this.idade = idade;
            return this;
        }

        public MotoristaBuilder withPontos(int pontos) {
            if (pontos < 0) throw new IllegalArgumentException("Pontos de CNH negativos.");
            this.pontos = pontos;
            return this;
        }
